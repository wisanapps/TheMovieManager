...
class MovieDetailViewController: UIViewController {
    ...
    }//end @IBAction func toggleFavorite(_ sender: AnyObject)
    ...
    }//end @IBAction func toggleWatchlist(_ sender: AnyObject)
    
}//end class MovieDetailViewController: UIViewController
